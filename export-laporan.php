...
$sheet = $spreadsheet->getActiveSheet(); // Menggunakan "->" bukan "=>"

$sheet->setCellValue('A1', 'No'); // Menggunakan "->" bukan "=>"
...
while ($d = mysqli_fetch_array($data)) {
    $sheet->setCellValue('A' . $i, $no++); // Menggunakan "->" bukan "=>"
...
$writer->save('Laporan Buku Tamu.xlsx'); // Menggunakan "->" bukan "=>"
